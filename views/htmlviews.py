...
class ViewDefinitionFactory(object):
    """
    ...
    def get_view(self, viewname):
        return self.views_cache[viewname]['view']

view_definitions = ViewDefinitionFactory(os.path.realpath(os.path.join('..','static','views')))